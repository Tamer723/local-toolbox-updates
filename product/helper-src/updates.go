...
// updaterPath prefers the side-by-side v2 updater introduced in 0.5.0. The
// legacy filename remains a fallback so older installations can still apply
// the 0.5.0 package; that package adds v2 without replacing the running 0.4.0
// updater executable.
func updaterPath(root string) (string, bool) {
