...
- The 0.5.0 package installs `local-toolbox-updater-v2.exe` beside the legacy updater, avoiding replacement of the running 0.4.0 updater; helper 0.5.0 prefers v2 for subsequent upgrades.
